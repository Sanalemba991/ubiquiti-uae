                        ...
                        >
                            <div className="backdrop-blur-lg bg-white/10 rounded-lg p-5 border border-white/20 shadow-md">
                                <form onSubmit={handleSubmit} className="space-y-3">
                                    {/* Name */}
                                    <div>
                                        <label className="block text-gray-700 text-xs mb-1 font-medium">Name <span className="text-red-500">*</span></label>
                                        <motion.input
                                    ...
                                    {/* Email */}
                                    <div>
                                        <label className="block text-gray-700 text-xs mb-1 font-medium">Email <span className="text-red-500">*</span></label>
                                        <motion.input
                                            whileFocus={{ scale: 1.01 }}
                                            transition={{ duration: 0.2 }}
                                            type="email"
                                    ...
                                    {/* Subject */}
                                    <div>
                                        <label className="block text-gray-700 text-xs mb-1 font-medium">Subject <span className="text-red-500">*</span></label>
                                        <motion.input
                                            whileFocus={{ scale: 1.01 }}
                                            transition={{ duration: 0.2 }}
                                            type="text"
                                    ...
                                    {/* Message */}
                                    <div>
                                        <label className="block text-gray-700 text-xs mb-1 font-medium">Message <span className="text-red-500">*</span></label>
                                        <motion.textarea
                                            whileFocus={{ scale: 1.01 }}
                                            transition={{ duration: 0.2 }}
                                            name="message"
