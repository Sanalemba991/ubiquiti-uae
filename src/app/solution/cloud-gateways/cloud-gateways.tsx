...
<span className="text-blue-600"> Filtering </span></>,
    subtitle: "Block traffic to over 100 categories of malicious, explicit, or unwanted content from your UniFi Network. With just a few clicks, stop traffic to sites linked to spyware, adult content, social media, and more. Content filtering helps you protect users and track attempts to access restricted sites.",
